...
Route::get('/carrier/inbound-dids', [InboundDidController::class, 'index'])->name('carrier.inbound-dids.index');
Route::get('/carrier/inbound-dids/create', [InboundDidController::class, 'create'])->name('carrier.inbound-dids.create');
Route::post('/carrier/inbound-dids', [InboundDidController::class, 'store'])->name('carrier.inbound-dids.store');
Route::get('/carrier/inbound-dids/{inboundDid}/edit', [InboundDidController::class, 'edit'])->name('carrier.inbound-dids.edit');
Route::put('/carrier/inbound-dids/{inboundDid}', [InboundDidController::class, 'update'])->name('carrier.inbound-dids.update');
Route::delete('/carrier/inbound-dids/{inboundDid}', [InboundDidController::class, 'destroy'])->name('carrier.inbound-dids.destroy');
