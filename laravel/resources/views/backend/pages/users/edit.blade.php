    ...
    <div class="connectpro-admin-page connectpro-record-form-page p-4 md:p-6">
        ...
        <div class="connectpro-record-form-layout">
            ...
            <aside class="connectpro-record-form-context">
                ...
                <p class="mt-4">{{ __('Changes follow the user permissions already configured for this account.') }}</p>
                <p class="mt-2">{{ __('Role, status, recording and SIP settings keep their existing behavior.') }}</p>
                <p class="mt-2">{{ __('Leave optional passwords blank to retain their current values.') }}</p>
            </aside>
        </div>
    </div>
@endsection
