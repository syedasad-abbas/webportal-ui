@once
<style>
.connectpro-record-form-page{--record-page:#f3f6fb;--record-card:#fff;--record-border:#d6e0eb;--record-input:#ffffff;--record-input-text:#0f172a;--record-heading:#0f172a;--record-label:#475569;--record-copy:#64748b;--record-placeholder:#94a3b8;min-height:100%;max-width:none;margin:0;background:var(--record-page);color:var(--record-heading);overflow-x:hidden}
.dark .connectpro-record-form-page{--record-page:#08111e;--record-card:#111c2b;--record-border:#263951;--record-input:#ffffff;--record-input-text:#0f172a;--record-heading:#f8fafc;--record-label:#cbd5e1;--record-copy:#aebed0;--record-placeholder:#718198}
...
.connectpro-record-form-actions .btn-primary,.connectpro-record-form-actions button[type="submit"]{min-width:188px;min-height:42px;border-radius:9px;background:#2563eb!important;color:#fff!important}
.connectpro-record-form-actions .btn-default{min-height:42px;border:1px solid var(--record-border);border-radius:9px;background:var(--record-input);color:var(--record-input-text)}
